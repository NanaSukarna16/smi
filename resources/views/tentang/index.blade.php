                    ...
                    <div class="font-bold text-xl">
                        ...
                        <a href="{{ route('tentang.create')}}">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                <i class="fas fa-plus"></i> Tentang Baru
                            </button>
                        </a>
                </div>
                    ...
                    <table class="table text-grey-darkest">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="{{route('tentang.edit', $item->id)}}">
                                            <i class="fas fa-edit"></i></a>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500" href="{{route('tentang.destroy', $item->id)}}" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')">
