                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="http://localhost:8000/storage/pengumuman/{{ $item->file }}" target = "_ blank">
                                        <img src="{{asset('storage/pengumuman/'.$item->img)}}" alt="image" width="70px"/>
                                    </a> 
                                </td>
                                <td>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="{{route('pengumuman.edit', $item->id)}}">
                                            <i class="fas fa-edit"></i></a>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500" href="{{route('pengumuman.destroy', $item->id)}}" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')">
