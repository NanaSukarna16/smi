...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template_be') }}/dist/all.css">
...
<div class="mx-auto bg-grey-400">
    ...
    <div class="min-h-screen flex flex-col">
            ...
            <div class="flex justify-between">
                <div class="p-1 mx-3 inline-flex items-center">
                    <i class="fas fa-bars pr-2 text-white" onclick="sidebarToggle()"></i>
                     <img class="me-3" src="{{ asset('template_fe') }}/img/icons/logo_smi.jpg" width="50px" alt="Icon">
                    {{-- <h1 class="text-white p-2">Logo</h1> --}}
                </div>
                <div class="p-1 flex flex-row items-center">
                    {{-- <img onclick="profileToggle()" class="inline-block h-8 w-8 rounded-full" src="https://avatars0.githubusercontent.com/u/4323180?s=460&v=4" alt=""> --}}
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Nana Sukarna
                        ...
                        <ul class="list-reset">
                          ...
                          <li>
                              <form action="{{ route('logout')}}" method="POST">
                                    @csrf
                                    <a type="submit" class="no-underline px-4 py-2 block text-black hover:bg-grey-light">
        ...
        <footer class="bg-grey-darkest text-white p-2">
            <div class="flex flex-1 mx-auto">&copy; SEBI Management institute</div>
        </footer>
        <!--/footer-->
...
<script src="{{ asset('template_be') }}/main.js"></script>
@stack('js-popup')
</body>
