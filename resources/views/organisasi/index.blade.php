            ...
            <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                <div class="px-6 py-2 border-b border-light-grey">
                    ...
                    <div class="font-bold text-xl">
                        Kepengurussan Organisasi SMI 
                    </div>
                        <a href="{{ route('organisasi.create')}}">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                <i class="fas fa-plus"></i> Organisasi Baru
                            </button>
                        </a>
                </div>
                    ...
                    <table class="table text-grey-darkest">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="pop">
                                        <img src="{{asset('storage/organisasi/'.$item->img)}}" alt="image" width="70px"/>
                                    </a> 
                                </td>
                                <td>{{ $item->jabatan }}</td>
                                <td>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="{{route('organisasi.edit', $item->id)}}">
                                            <i class="fas fa-edit"></i></a>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500" href="{{route('organisasi.destroy', $item->id)}}" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')">
