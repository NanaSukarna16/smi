                    ...
                    <table class="table text-grey-darkest">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="pop">
                                        <img src="{{asset('storage/highlight/'.$item->img)}}" alt="image" width="70px"/>
                                    </a> 
                                </td>
                                <td>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="{{route('highlight.edit', $item->id)}}">
                                            <i class="fas fa-edit"></i></a>
                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500" href="{{route('highlight.destroy', $item->id)}}" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')">
